package com.hexdragon.blacksmithre.block.grindstone;

import com.hexdragon.corere.item.CraftResultInventoryRe;
...
public class GrindstoneContainerRe extends Container {
    ...
    private ItemStack prepareNewItem(ItemStack stack) {
        ...
        // 普通难度下消耗 0.4 个物品原料的耐久
        final float[] radio = {0};
        worldPosCallable.consume((world, pos) -> radio[0] = new float[]{0.2f, 0.3f, 0.4f, 0.5f}[world.getDifficulty().getId()]);
        // 设置损伤值
